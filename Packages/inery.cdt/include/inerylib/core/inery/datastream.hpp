   ...
   public:
      ...
      */
      inline bool read( char* d, size_t s ) {
        inery::check( size_t(_end - _pos) >= (size_t)s, "datastream attempted to read past the end" );
        memcpy( d, _pos, s );
        _pos += s;
        return true;
      }
      ...
      */
      inline bool write( const char* d, size_t s ) {
        inery::check( _end - _pos >= (int32_t)s, "datastream attempted to write past the end" );
      ...
      */
      inline bool write( char d ) {
        inery::check( _end - _pos >= 1, "datastream attempted to write past the end" );
        *_pos++ = d;
        return true;
      }

...
icon: http://127.0.0.1/ricardian_assets/inery.contracts/icons/rex.png#d229837fa62a464b9c71e06060aa86179adf0b3f4e3b8c4f9702f4f4b0c340a8
---

{{amount}} is taken out of {{from}}’s REX fund and used to purchase REX tokens at the current market exchange rate. In order for the action to succeed, {{from}} must have voted for a proxy or at least 21 block masters. {{amount}} is added to {{from}}’s vote stake.
...
---
spec_version: "0.2.0"
title: Claim Block master Rewards
...
<h1 class="contract">regmaster</h1>

---
spec_version: "0.2.0"
title: Register as a Block master Candidate
summary: 'Register {{nowrap master}} account as a block master candidate'
...
Register {{master}} account as a block master candidate.

URL: {{url}}
Location code: {{location}}
Block signing key: {{master_key}}

## Block master Agreement
{{$clauses.BlockmasterAgreement}}

<h1 class="contract">regmaster2</h1>
...
<h1 class="contract">rmvmaster</h1>

---
spec_version: "0.2.0"
title: Forcibly Unregister a Block master Candidate
summary: '{{nowrap master}} is unregistered as a block master candidate'
icon: http://127.0.0.1/ricardian_assets/inery.contracts/icons/admin.png#9bf1cec664863bd6aaac0f814b235f8799fb02c850e9aa5da34e8a004bd6518e
---

{{$action.account}} unregisters {{master}} as a block master candidate. {{master}} account will retain its votes and those votes can change based on voter stake changes or votes removed from {{master}}. However new voters will not be able to vote for {{master}} while it remains unregistered.

<h1 class="contract">deallocate</h1>
...
---
spec_version: "0.2.0"
title: Sell REX Tokens in Exchange for INE
...
* Fraction of inflation used to reward block masters: 10000/{{inflation_pay_factor}}
* Fraction of block master rewards to be distributed proportional to blocks produced: 10000/{{votepay_factor}}
...
<h1 class="contract">unregmaster</h1>

---
spec_version: "0.2.0"
title: Unregister as a Block master Candidate
summary: '{{nowrap master}} unregisters as a block master candidate'
icon: http://127.0.0.1/ricardian_assets/inery.contracts/icons/voting.png#db28cd3db6e62d4509af3644ce7d377329482a14bb4bfaca2aa5f1400d8e8a84
---

{{master}} unregisters as a block master candidate. {{master}} account will retain its votes and those votes can change based on voter stake changes or votes removed from {{master}}. However new voters will not be able to vote for {{master}} while it remains unregistered.
...
{{from_net}} and {{from_cpu}} are withdrawn from {{receiver}}’s NET and CPU bandwidths respectively. These funds are used to purchase REX tokens at the current market exchange rate. In order for the action to succeed, {{owner}} must have voted for a proxy or at least 21 block masters.
...
<h1 class="contract">votemaster</h1>

---
spec_version: "0.2.0"
title: Vote for Block masters
summary: '{{nowrap voter}} votes for {{#if proxy}}the proxy {{nowrap proxy}}{{else}}up to 30 block master candidates{{/if}}'
icon: http://127.0.0.1/ricardian_assets/inery.contracts/icons/voting.png#db28cd3db6e62d4509af3644ce7d377329482a14bb4bfaca2aa5f1400d8e8a84
---

{{#if proxy}}
{{voter}} votes for the proxy {{proxy}}.
At the time of voting the full weight of voter’s staked (CPU + NET) tokens will be cast towards each of the masters voted by {{proxy}}.
{{else}}
{{voter}} votes for the following block master candidates:

{{#each masters}}
  + {{this}}
{{/each}}

At the time of voting the full weight of voter’s staked (CPU + NET) tokens will be cast towards each of the above masters.
{{/if}}

...
---
spec_version: "0.2.0"
title: Set Block masters
summary: 'Set block master schedule'
icon: http://127.0.0.1/ricardian_assets/inery.contracts/icons/admin.png#9bf1cec664863bd6aaac0f814b235f8799fb02c850e9aa5da34e8a004bd6518e
---

{{$action.account}} proposes a block master schedule of:
{{#each schedule}}
  1. {{this.master_name}}
{{/each}}

The block signing authorities of each of the masters in the above schedule are listed below:
{{#each schedule}}
### {{this.master_name}}

...
namespace ineryboot
{
   ...
   /**
    * @defgroup ineryboot inery.boot
    * @ingroup inerycontracts
    *
    * inery.boot is a extremely minimalistic system contract that only supports the native actions and an
    * activate action that allows activating desired protocol features prior to deploying a system contract
    * with more features such as inery.bios or inery.system.
    *
    * @{
    */
   class [[inery::contract("inery.boot")]] boot : public inery::contract
   {
   public:
      ...
      using opendb_action = action_wrapper<"newaccount"_n, &boot::newaccount>;
   ...
   /** @}*/ // end of @defgroup ineryboot inery.boot
} /// namespace ineryboot
